...
public class DefaultData
{
    ...
    public static WorldData Create()
    {
        ...
        {
            { new() { x = -10, y = 14 }, 2}, { new() { x = -4, y = 14 }, 2}, { new() { x = 2, y = 14 }, 63}, { new() { x = 7, y = 14 }, 27}, { new() { x = 12, y = 14 }, 10}, { new() { x = -1, y = 12 }, 24}, { new() { x = -4, y = 10 }, 24}, { new() { x = 11, y = 10 }, 26}, { new() { x = -10, y = 9 }, 2}, { new() { x = 4, y = 9 }, 6}, { new() { x = -6, y = 7 }, 24}, { new() { x = 8, y = 7 }, 26}, { new() { x = -9, y = 5 }, 4}, { new() { x = 0, y = 5 }, 6}, { new() { x = 5, y = 5 }, 6}, { new() { x = -4, y = 4 }, 4}, { new() { x = 11, y = 3 }, 36}, { new() { x = -1, y = 2 }, 58}, { new() { x = 8, y = 2 }, 0}, { new() { x = -8, y = 1 }, 4}, { new() { x = 6, y = 0 }, 0}, { new() { x = -5, y = -1 }, 58}, { new() { x = 2, y = -1 }, 0}, { new() { x = -8, y = -3 }, 51}, { new() { x = 5, y = -3 }, 0}, { new() { x = 9, y = -3 }, 34}, { new() { x = 0, y = -4 }, 1}, { new() { x = -4, y = -5 }, 1}, { new() { x = -10, y = -6 }, 17}, { new() { x = 3, y = -6 }, 19}, { new() { x = 8, y = -8 }, 34}, { new() { x = -6, y = -9 }, 1}, { new() { x = -1, y = -9 }, 19}, { new() { x = -10, y = -10 }, 17}, { new() { x = 2, y = -11 }, 19}, { new() { x = 11, y = -11 }, 3},
        };
